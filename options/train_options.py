...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_distan_struct', type=float, default=5.0, help='weight for disantangled struct consistency loss')
        self.parser.add_argument('--lambda_distan_text', type=float, default=5.0, help='weight for disantangled texture consistency loss')
